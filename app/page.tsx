  ...
  return (      
    <div className="bg-gray-800 h-screen">
      <div className="relative w-full h-full">
        ...
        <Sidebar shops={shops} selectedShop={selectedShop} handleShopTileClick={(s: Shop) => handleShopTileClick(s)}/>
      </div>
    </div>
  );
...
type SideBarProps = {
  ...
  handleShopTileClick: (s: Shop) => void
}

function Sidebar({shops, selectedShop, handleShopTileClick} : SideBarProps){
